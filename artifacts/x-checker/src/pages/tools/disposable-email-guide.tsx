...
const PROVIDERS_TABLE = [
  ...
  { name: "mail.tm", desc: "Account-based, persistent, cleaner UI, multiple domains", bestFor: "Longer-term temporary use", href: "https://mail.tm" },
];
...
const faqs = [
  ...
  { q: "How long do disposable emails last?", a: "It depends on the provider. Some (like 10MinuteMail) expire after 10 minutes. Others (like our Temp Mail tool) persist for your browser session. Some providers (like mail.tm) offer semi-permanent accounts that last weeks or months until inactivity triggers deletion." },
